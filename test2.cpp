...
//******************************************************************
//******************************************************************
// This is code that I added so the user can add a year to check
        if(Date::isLeapYear(year))
        {
            cout << "Correctly says " << year <<" is a leap year." << endl;
        }
        else
        {
            cout << "Correctly says " << year << " is NOT a leap year." << endl;
        }
// This is code that I added so the user can add a year to check
//******************************************************************
//******************************************************************
